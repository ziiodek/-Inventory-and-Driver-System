...
<br>
<button type="button" class="btn btn-primary purple-btn" style='width:100%;' id='action0'>Trip Information</button>
<br>
<br>


      <h4>Send Trip Status</h4>
 

<br>

<center>
<button type="button" class="btn btn-primary purple-btn" style='width:100%;' id='action1'>Leaving Base</button><br>
<button type="button" class="btn btn-primary purple-btn" style='width:100%;' id='action2'>At Port of Entry</button><br>
<button type="button" class="btn btn-primary purple-btn" style='width:100%;' id='action3'>Receiving Documents</button><br>
  <button type="button" class="btn btn-primary purple-btn" style='width:100%;' id='action4'>Arriving at Destiny and deliver cargo</button><br>
  <br>
