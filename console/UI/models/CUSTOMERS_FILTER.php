...
<input type="number" name="customerid" id="customerid" class="form-control" placeholder="Customer ID">
</div>
<div class="col-sm-6">
<label>Name:</label>
...
<script src="../../js/CountriesEvents.js"></script>
  <script>
    $unactiveFields__CustomerId = ["name","country","state"];
    $unactiveFields__Name = ["customerid","country","state"];
    $unactiveFields__State = ["customerid","name","country"];
    $unactiveFields__Country = ["customerid","name","state"];
    initField__onClickEvent("customerid",$unactiveFields__CustomerId);
